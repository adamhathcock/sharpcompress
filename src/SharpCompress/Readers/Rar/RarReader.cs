        ...
        IRarAsyncReader
{
    ...
    public static IRarReader OpenReader(string filePath, ReaderOptions? readerOptions = null)
    {
        filePath.NotNullOrEmpty(nameof(filePath));
        return OpenReader(new FileInfo(filePath), readerOptions);
    }

    public static IRarReader OpenReader(FileInfo fileInfo, ReaderOptions? readerOptions = null)
    {
        readerOptions ??= new ReaderOptions { LeaveStreamOpen = false };
        return OpenReader(fileInfo.OpenRead(), readerOptions);
    }

    public static IRarReader OpenReader(
    ...
    /// <returns></returns>
    public static IRarReader OpenReader(Stream stream, ReaderOptions? readerOptions = null)
    {
    ...
    /// <returns></returns>
    public static IRarReader OpenReader(IEnumerable<Stream> streams, ReaderOptions? options = null)
    {
