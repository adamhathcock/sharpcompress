namespace SharpCompress.Compressor.PPMd.I1
{
    ...
    //        {
    //            index += (indexToUnits[index] < (num2 + 1)) ? 1 : 0;
    ...
    //                return (((this.BaseUnit - this.Text) > num) ? (this.BaseUnit -= ((Pointer) num)) : Pointer.Zero);
    //            }
    //        }
    ...
    //        }
    //        this.Text = this.Heap;
    //        uint num2 = 12 * (((this.AllocatorSize / 8) / 12) * 7);
    //        this.HighUnit = this.Heap + ((Pointer) this.AllocatorSize);
    //        this.LowUnit = this.HighUnit - ((Pointer) num2);
    //        this.BaseUnit = this.HighUnit - ((Pointer) num2);
    //        this.GlueCount = 0;
    //    }
    ...
    //        else
    //        {
    //            this.BaseUnit += (Pointer) (unitCount * 12);
    //        }
    //        return target;
    //    }
